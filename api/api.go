...
import (
	...
	ahandler "github.com/dreamlu/go-micro/v2/api/handler"
	aapi "github.com/dreamlu/go-micro/v2/api/handler/api"
	"github.com/dreamlu/go-micro/v2/api/handler/event"
	ahttp "github.com/dreamlu/go-micro/v2/api/handler/http"
	arpc "github.com/dreamlu/go-micro/v2/api/handler/rpc"
	"github.com/dreamlu/go-micro/v2/api/handler/web"
	"github.com/dreamlu/go-micro/v2/api/resolver"
	"github.com/dreamlu/go-micro/v2/api/resolver/grpc"
	"github.com/dreamlu/go-micro/v2/api/resolver/host"
	"github.com/dreamlu/go-micro/v2/api/resolver/path"
	"github.com/dreamlu/go-micro/v2/api/router"
	regRouter "github.com/dreamlu/go-micro/v2/api/router/registry"
	"github.com/dreamlu/go-micro/v2/api/server"
	"github.com/dreamlu/go-micro/v2/api/server/acme"
	"github.com/dreamlu/go-micro/v2/api/server/acme/autocert"
	"github.com/dreamlu/go-micro/v2/api/server/acme/certmagic"
	httpapi "github.com/dreamlu/go-micro/v2/api/server/http"
	log "github.com/dreamlu/go-micro/v2/logger"
	"github.com/dreamlu/go-micro/v2/store"
	"github.com/dreamlu/go-micro/v2/sync/memory"
	"github.com/dreamlu/micro/v2/api/auth"
	"github.com/dreamlu/micro/v2/internal/handler"
	"github.com/dreamlu/micro/v2/internal/helper"
	"github.com/dreamlu/micro/v2/internal/namespace"
	rrmicro "github.com/dreamlu/micro/v2/internal/resolver/api"
	"github.com/dreamlu/micro/v2/internal/stats"
